...
# cnv supplemental figure table:
tn = "out/cnv_wilcox_table.txt"
write.table(wilcox_cnv_df, quote=F, sep="\t", file = tn, row.names = F)
...
# aneuploidy supplemental figure table:
tn = "out/aneuploidy_wilcox_table.txt"
write.table(wilcox_aneuploidy_df, quote=F, sep="\t", file = tn, row.names = F)
...
# leukocyte fraction supplemental figure table:
tn = "out/leukocyte_wilcox_table.txt"
write.table(wilcox_leukocyte_df, quote=F, sep="\t", file = tn, row.names = F)