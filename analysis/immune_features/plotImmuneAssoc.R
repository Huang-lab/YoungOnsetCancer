...
assoc_Th_Cells_n = "out/Th_Cells_onsetAgeBinary_assoc.txt"
...
assoc_neo_n = "out/Neoantigens_onsetAgeBinary_assoc.txt"
...
#p = p + theme(legend.position = "top")
p
fn = 'out/Neoantigens_heatmap.pdf'
...
assoc_mut_n = "out/Mut_Rate_onsetAgeBinary_assoc.txt"
